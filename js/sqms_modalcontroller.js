 ...
 ***********************************************************/
var modul = angular.module('SQMSApp', ['ngSanitize', 'xeditable', 'ui.bootstrap', 'ui.tinymce', 'ui.select'])



modul.controller('ModalInstanceCtrl', function ($scope, $window, $http, $uibModalInstance, items, cmd, Elem) {
