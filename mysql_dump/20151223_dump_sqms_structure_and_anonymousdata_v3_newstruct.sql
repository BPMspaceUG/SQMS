...
CREATE TABLE `sqms_question` (
  ...
  CONSTRAINT `fk_sqms_question_sqms_state1` FOREIGN KEY (`sqms_state_id`) REFERENCES `sqms_syllabus_state` (`sqms_syllabus_state_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `sqms_question_state_rules` (
  ...
  CONSTRAINT `fk_sqms_question_state_rules_sqms_state1` FOREIGN KEY (`sqms_state_id_FROM`) REFERENCES `sqms_syllabus_state` (`sqms_syllabus_state_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_sqms_question_state_rules_sqms_state2` FOREIGN KEY (`sqms_state_id_TO`) REFERENCES `sqms_syllabus_state` (`sqms_syllabus_state_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
