...
CREATE TABLE `sqms_question` (
  ...
  CONSTRAINT `fk_sqms_question_sqms_state1` FOREIGN KEY (`sqms_state_id`) REFERENCES `sqms_syllabus_state` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `sqms_question_state` (
  ...
  PRIMARY KEY (`sqms_question_state_id`,`sqms_state_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sqms_question_state` VALUES (1,1,'new'),(2,2,'ready'),(3,3,'released'),(4,4,'deprecated');
...
CREATE TABLE `sqms_question_state_rules` (
  ...
  CONSTRAINT `fk_sqms_question_state_rules_sqms_state1` FOREIGN KEY (`sqms_state_id_FROM`) REFERENCES `sqms_syllabus_state` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_sqms_question_state_rules_sqms_state2` FOREIGN KEY (`sqms_state_id_TO`) REFERENCES `sqms_syllabus_state` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sqms_syllabus` (
  ...
  CONSTRAINT `fk_sqms_syllabus_sqms_state1` FOREIGN KEY (`sqms_state_id`) REFERENCES `sqms_syllabus_state` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
--
-- Table structure for table `sqms_syllabus_state_neu`
--

DROP TABLE IF EXISTS `sqms_syllabus_state_neu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sqms_syllabus_state_neu` (
  `sqms_syllabus_state_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(45) NOT NULL,
  `value` int(11) NOT NULL,
  PRIMARY KEY (`sqms_syllabus_state_id`),
  UNIQUE KEY `idsqms_syllabus_state_id_UNIQUE` (`sqms_syllabus_state_id`),
  UNIQUE KEY `name_UNIQUE` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sqms_syllabus_state_neu`
--

LOCK TABLES `sqms_syllabus_state_neu` WRITE;
/*!40000 ALTER TABLE `sqms_syllabus_state_neu` DISABLE KEYS */;
INSERT INTO `sqms_syllabus_state_neu` VALUES (1,'new',10),(2,'ready',80),(3,'released',100),(4,'deprecated',999);
/*!40000 ALTER TABLE `sqms_syllabus_state_neu` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `sqms_syllabus_state_rules` (
  ...
  CONSTRAINT `fk_sqms_syllabus_state_rules_sqms_state1` FOREIGN KEY (`sqms_state_id_FROM`) REFERENCES `sqms_syllabus_state` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_sqms_syllabus_state_rules_sqms_state2` FOREIGN KEY (`sqms_state_id_TO`) REFERENCES `sqms_syllabus_state` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-01-15 14:42:02
